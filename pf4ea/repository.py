...
def save_report_csv(
    ...
    report_data = {
        ...
        "path_length": solver.solution_length,
        "path_cost": get_path_cost(solver.solution, problem.grid),
        "tot_states": solver.closed_list_size,
        "percentage_visited_nodes": solver.percentage_visited_nodes,
        "wait": solver.wait,
